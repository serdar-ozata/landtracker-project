...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"../../node_modules/validator/es/lib/util/assertString.js":[function(require,module,exports) {
"use strict";
...
var active = "custom-feedback-active";

var activateLogin = /*#__PURE__*/function () {
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        if (!(0, _isEmail.default)(email.value)) {
                          _context.next = 21;
                          break;
                        }
                      ...
                      case 12:
                        ...
                        if (_context.t0.response.data.message === "EorP") {
                          feedbacks[2].classList.add(active);
                        } else if (_context.t0.response.data.message === "AcErr") {
  ...
  return function activateLogin(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.activateLogin = activateLogin;

function activateEmailToast() {
  var toastElement = document.getElementById("emailConfirmToast");
...
var logout = function logout(button) {
  button.addEventListener("click", function (ev) {
    (0, _axios.default)({
      method: "POST",
      url: "".concat(window.location.origin, "/logout")
    });
...
var sendResetPassword = function sendResetPassword(form) {
  var email = document.getElementById("resetEmail");
  var feedbacks = document.getElementsByClassName("custom-feedback");
  email.addEventListener("input", function (e) {
    email.classList.remove("is-invalid");
    email.classList.remove("is-valid");
  });
  form.addEventListener("submit", function (ev) {
    ...
    ev.stopPropagation();
    var val = email.value;
    var activeElement = email.parentElement.getElementsByClassName(active);
    ...
    if ((0, _isEmail.default)(val)) {
      ...
      (0, _axios.default)({
        method: "POST",
        url: "".concat(window.location.origin, "/forgotPassword"),
        data: {
          email: val
        }
      }).then(function (e) {
        var rows = document.getElementsByClassName("mb-3");
...
var resetPassword = function resetPassword(form) {
  var pass = document.getElementById("inPass");
  var passConfirm = document.getElementById("inPassConfirm");
  var feedbacks = document.getElementsByClassName("custom-feedback");
  [pass, passConfirm].forEach(function (el) {
    el.addEventListener("input", function (ev) {
      return ev.target.classList.remove("is-valid", "is-invalid");
    });
  });
  form.addEventListener("submit", function (ev) {
    ev.preventDefault();
  ...
  function validatePassword() {
    var activeElement = pass.parentElement.getElementsByClassName(active);
...
},{"axios":"../../node_modules/axios/index.js","validator/es/lib/isEmail":"../../node_modules/validator/es/lib/isEmail.js"}],"repository_edit.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.save = exports.initWarningModal = exports.editMessage = exports.copyId = exports.activateTTs = void 0;
...
var url = window.location.href.substring(0, window.location.href.length - 5);
var dictionary = {
  c_tt_init: {
    tr: "Panoya kopyala",
...
var initWarningModal = function initWarningModal(modal) {
  var warningModal = modal;
  var warningText = document.getElementById("warning-text");
  var undoneText = document.getElementById("warning-undone-text");
  var confirmButton = modal.getElementsByClassName("accept-btn")[0];
  var kickButtons = document.querySelectorAll(".kick-user");
  var rejectButtons = document.querySelectorAll(".btn-reject");
  var acceptButtons = document.querySelectorAll(".btn-accept");
  var authButtons = document.querySelectorAll(".btn-auth");
  var adminButtons = document.querySelectorAll(".btn-admin");
  var deauthButtons = document.querySelectorAll(".btn-deauth");
  var serverMethod;
  var urlExtension;
  confirmButton.addEventListener("click", function (ev) {
    (0, _axios.default)({
      method: serverMethod,
      url: "".concat(url, "/").concat(urlExtension)
    }).then(function (ev) {
  ...
  var confirm = function confirm(method, url, text) {
    var activateUndone = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    serverMethod = method;
    urlExtension = url;
    warningText.innerText = text;
    if (activateUndone) undoneText.classList.remove("d-none");else undoneText.classList.add("d-none");
  };

  var reject = function reject(button) {
    button.addEventListener("click", function (evt) {
      (0, _axios.default)({
        method: 'DELETE',
        url: "".concat(url, "/permission/").concat(button.id.substring(6))
      });
    });
  };

  var accept = function accept(button) {
    button.addEventListener("click", function (evt) {
      (0, _axios.default)({
        method: 'POST',
        url: "".concat(url, "/permission/").concat(button.id.substring(10))
      });
    });
  };

  var kick = function kick(button) {
    button.addEventListener("click", function (evt) {
      // axios({
      //     method: 'DELETE',
      //     url: `${url.substring(0, url.length - 5)}/user/${button.id.substring(4)}`,
      // })
      confirm("DELETE", "user/".concat(button.getAttribute("data-bs-id")), "".concat(dictionary.u_kick_1, " ").concat(getName(button), " ").concat(dictionary.u_kick_2), true);
    });
  };

  var authorizeEdit = function authorizeEdit(button) {
    button.addEventListener("click", function (evt) {
      // axios({
      //     method: 'POST',
      //     url: `${url.substring(0, url.length - 5)}/user/${button.id.substring(4)}`,
      // })
      confirm("POST", "user/".concat(button.getAttribute("data-bs-id"), "/std"), "".concat(dictionary.u_upgrade_1[dictionary], " ").concat(getName(button), " ").concat(dictionary.u_upgrade_2[_index.language]));
    });
  };

  var makeAdmin = function makeAdmin(button) {
    button.addEventListener("click", function (evt) {
      // axios({
      //     method: 'POST',
      //     url: `${url.substring(0, url.length - 5)}/user/${button.id.substring(2)}`,
      // })
      confirm("POST", "user/".concat(button.getAttribute("data-bs-id"), "/edit/admin"), "".concat(dictionary.u_admin_1[_index.language], " ").concat(getName(button), " ").concat(dictionary.u_admin_2[_index.language]), true);
    });
  };

  var deauthorize = function deauthorize(button) {
    button.addEventListener("click", function (evt) {
      // axios({
      //     method: 'POST',
      //     url: `${url.substring(0, url.length - 5)}/user/${button.id.substring(6)}`,
      // })
      confirm("POST", "user/".concat(button.getAttribute("data-bs-id"), "/edit"), "".concat(dictionary.u_deauth_1[_index.language], " ").concat(getName(button), " ").concat(dictionary.u_deauth_2[_index.language]));
    });
  };

  if (kickButtons) {
    kickButtons.forEach(function (value, key) {
      kick(value);
    });
  }

  if (rejectButtons) {
    rejectButtons.forEach(function (value, key) {
      reject(value);
    });
  }

  if (acceptButtons) {
    acceptButtons.forEach(function (value, key) {
      accept(value);
    });
  }

  if (authButtons) {
    authButtons.forEach(function (value, key) {
      authorizeEdit(value);
    });
  }

  if (adminButtons) {
    adminButtons.forEach(function (value, key) {
      makeAdmin(value);
    });
  }

  if (deauthButtons) {
    deauthButtons.forEach(function (value, key) {
      deauthorize(value);
    });
  }
};

exports.initWarningModal = initWarningModal;

var save = function save(button) {
  var name = document.getElementById("inName");
  var description = document.getElementById("inDescription");
  var radioAuth = document.getElementById("radio-auth");
  var checkAuth = document.getElementById("checkAuth");
  var oldMap = {
    name: name.value,
  ...
  if (radioAuth && radioAuth.childElementCount === 3) {
    for (var i = 0; i < 3; i++) {
      var el = radioAuth.children[i].children[0];
  ...
  name.addEventListener("change", function (ev) {
    ...
    var matched = target.value === oldMap.name;
    map.name = matched;
    checkMaps(matched);
  });
  description.addEventListener("change", function (ev) {
    var target = ev.target;
    var matched = target.value === oldMap.description;
    map.description = matched;
    checkMaps(matched);
  });

  if (radioAuth) {
    radioAuth.addEventListener("change", function (ev) {
      var target = ev.target;
      var matched = target.id === oldMap.privacy;
      map.privacy = matched;
      checkMaps(matched);
    });
  }
  ...
  if (checkAuth) {
    checkAuth.addEventListener("change", function (ev) {
      var target = ev.target;
      var matched = target.checked === oldMap.auth;
      map.auth = matched;
      checkMaps(matched);
    });
  }
  ...
  button.addEventListener("click", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(ev) {
      var promises, data, basicReq, highReq, _i, _el;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (!map.auth) {
                promises.push((0, _axios.default)({
                  method: 'PATCH',
                  url: "".concat(window.location.href, "/auth"),
                  data: {
            ...
            case 11:
              ...
              _el = radioAuth.children[_i].children[0];
  ...
  function checkMaps(matched) {
    if (matched) {
      if (map.name && map.description && map.auth && map.privacy) button.classList.add("disabled");
    } else {
...
var editMessage = function editMessage(modal) {
  modal.addEventListener('show.bs.modal', function (event) {
    var button = event.relatedTarget;
    var message = button.getAttribute('data-bs-message');
    var owner = button.getAttribute('data-bs-owner');
    var modalTitle = document.querySelector('.modal-title');
    var modalBodyInput = modal.querySelector('.modal-body p');
    modalTitle.textContent = "".concat(owner, "'").concat(dictionary.r_message[_index.language]);
...
var copyId = function copyId(btn) {
  var repoId = document.getElementById("repId").innerText;
  var tooltip = new bootstrap.Tooltip(btn, {
    trigger: "manual"
  });
  var manual = false;
  btn.addEventListener("click", function (ev) {
    navigator.clipboard.writeText(repoId).then(function (ev) {
      tooltip.hide();
      manual = true;
      btn.setAttribute("data-bs-original-title", dictionary.c_tt_done[_index.language]);
    });
  });
  ...
  btn.addEventListener("hidden.bs.tooltip", function (ev) {
    if (manual) {
      manual = false;
      setTimeout(function () {
        tooltip.show();
      ...
      btn.setAttribute("data-bs-original-title", dictionary.c_tt_init[_index.language]);
    }
  });
};
...
var activateTTs = function activateTTs() {
  var ttList = document.getElementsByClassName("tt");
...
exports.activateTTs = activateTTs;

var getName = function getName(btn) {
  return btn.parentElement.parentElement.parentElement.parentElement.children[0].children[0].innerText;
};
},{"axios":"../../node_modules/axios/index.js","./index":"index.js"}],"../../node_modules/validator/lib/util/assertString.js":[function(require,module,exports) {
"use strict";
...
},{}],"../../node_modules/validator/lib/isHexadecimal.js":[function(require,module,exports) {
"use strict";
...
},{}],"../../node_modules/validator/lib/isAlphanumeric.js":[function(require,module,exports) {
"use strict";
...
},{"./util/assertString":"../../node_modules/validator/lib/util/assertString.js","./alpha":"../../node_modules/validator/lib/alpha.js"}],"../../node_modules/validator/es/lib/isStrongPassword.js":[function(require,module,exports) {
"use strict";
...
},{"./util/merge":"../../node_modules/validator/es/lib/util/merge.js","./util/assertString":"../../node_modules/validator/es/lib/util/assertString.js"}],"user_settings.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.validateName = exports.upgrade = exports.showError = exports.removeRequests = exports.changePassword = exports.changeName = void 0;

var _axios = _interopRequireDefault(require("axios"));

var _isAlphanumeric = _interopRequireDefault(require("validator/lib/isAlphanumeric"));

var _isStrongPassword = _interopRequireDefault(require("validator/es/lib/isStrongPassword"));
...
var toastErrorCode = document.getElementById("toast-err-code");
var toastErrorMessage = document.getElementById("toast-err-message");
var dictionary = {
  def_err: {
...
var validateName = function validateName(input, feedbacks) {
  var val = input.value.trim();
  var activeElement = input.parentElement.getElementsByClassName(active);
  ...
  if (val.length === 0) {
    ...
    feedbacks[1].classList.add(active);
  } else if (!(0, _isAlphanumeric.default)(val, 'tr-TR', {
    ignore: " -"
  })) {
    feedbacks[2].classList.add(active);
  } else {
...
var changeName = function changeName(discard, submit) {
  var input = document.getElementById("inChangeName");
  var nameField = document.getElementById("name_field");
  var feedbacks = input.parentElement.getElementsByClassName("custom-feedback");
  ...
  submit.addEventListener("click", function (ev) {
    if (validateName(input, feedbacks)) {
      ...
      (0, _axios.default)({
        ...
        discard.click();
        showSuccess(dictionary.s_name[_index.language]);
      }).catch(function (e) {
        discard.classList.remove("disabled");
        submit.innerText = "Send";
        discard.click();
...
var upgrade = function upgrade(discard, submit) {
  ...
  submit.addEventListener("click", function (ev) {
    ...
    (0, _axios.default)({
      ...
      showSuccess(dictionary.s_upgrade[_index.language]);
    }).catch(function (e) {
      discard.classList.remove("disabled");
      submit.innerText = "Send";
      discard.click();
...
var changePassword = function changePassword(discard, submit) {
  var oldPass = document.getElementById("inOldPass");
  var pass = document.getElementById("inPass");
  var passConfirm = document.getElementById("inPassConfirm");
  var passForm = document.getElementById('passForm');
  var feedBacks = pass.parentElement.getElementsByClassName("custom-feedback");
  var oldFeedBacks = oldPass.parentElement.getElementsByClassName("custom-feedback");
  passForm.addEventListener('submit', function (event) {
    ...
    if (validatePassForm()) {
      ...
      (0, _axios.default)({
        ...
        discard.click();
        showSuccess(dictionary.s_pass[_index.language]);
      }).catch(function (e) {
  ...
  discard.parentElement.parentElement.parentElement.parentElement.parentElement.addEventListener("hidden.bs.modal", function (ev) {
    passConfirm.value = "";
    pass.value = "";
    submit.classList.remove("disabled");
  ...
  function validateOldPass() {
    var activeElement = oldPass.parentElement.getElementsByClassName(active);
    var removed = activeElement.length === 0;
...
var removeRequests = function removeRequests(cancelButtons) {
  var requestCounter = document.getElementById("request-count");

  var _loop = function _loop(i) {
    var btn = cancelButtons[i];
    btn.addEventListener("click", function (ev) {
      btn.classList.add("disabled");
      btn.innerText = "Canceling";
      (0, _axios.default)({
        method: "DELETE",
        url: "http://localhost:3000/user/request/".concat(btn.id.substring(3))
      }).then(function (r) {
...
var showError = function showError(code) {
  var message = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : dictionary.def_err[_index.language];
  var delay = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 7;
...
},{"axios":"../../node_modules/axios/index.js","validator/lib/isAlphanumeric":"../../node_modules/validator/lib/isAlphanumeric.js","validator/es/lib/isStrongPassword":"../../node_modules/validator/es/lib/isStrongPassword.js","./index":"index.js"}],"repository.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showSuccess = exports.search = exports.leaveRepos = exports.deleteRepos = exports.createRequest = exports.createRepos = void 0;
...
var search = function search(input) {
  ...
  document.querySelectorAll(".repos-card").forEach(function (card) {
    repositories.set(card.children[0].children[1].children[0].children[0].children[0].innerText.toLowerCase(), card);
  });
  input.addEventListener("input", function (ev) {
    var searchVal = ev.target.value.trim().toLowerCase();

    if (searchVal === "") {
      repositories.forEach(function (val) {
        val.removeAttribute("hidden");
      });
    } else {
      repositories.forEach(function (value, key) {
        if (key.includes(searchVal)) value.removeAttribute("hidden");else value.setAttribute("hidden", true);
      });
    }
  });
};
...
var createRequest = function createRequest(createButton, discardButton) {
  var repositoryId = document.getElementById("floatingInRequest");
  var repositoryMessage = document.getElementById("floatingInMessage");
  var feedbacks = repositoryId.parentElement.getElementsByClassName("custom-feedback");
  var idContainers = document.getElementsByClassName("id-container");
  var ids = new Set();

  for (var i = 0; i < idContainers.length; i++) {
    ids.add(idContainers[i].getAttribute('data-bs-id'));
  }

  repositoryId.addEventListener("input", function (ev) {
    var idInput = repositoryId.value;
    repositoryId.classList.remove("is-invalid");
    if (idInput.length === 24 && (0, _isHexadecimal.default)(idInput)) createButton.classList.remove("disabled");else createButton.classList.add("disabled");
  });
  ...
  createButton.addEventListener("click", function (ev) {
    if (checkCurrentRepositories(repositoryId.value)) {
      ...
      (0, _axios.default)({
        method: 'POST',
        url: "http://localhost:3000/user/request/repository/".concat(repositoryId.value),
        data: {
        ...
        if (e.data.message === "Sent") {
          showSuccess(dictionary.r_sent[_index.language]);
        } else if (e.data.message === "Accepted") {
          showSuccess(dictionary.r_joined[_index.language]);
        }
      }).catch(function (e) {
        discardButton.classList.remove("disabled");
        createButton.innerText = "Send";
      ...
      var activeEl = repositoryId.parentElement.getElementsByClassName(active);
...
var createRepos = function createRepos(discardButton, createButton) {
  var visibility = document.getElementById("floatingInVisibility");
  var name = document.getElementById("floatingInName");
  var description = document.getElementById("floatingInDesc");
  discardButton.addEventListener("click", function (ev) {
    name.value = "";
    description.value = "";
    createButton.classList.remove("disabled");
  ...
  name.addEventListener("input", function (ev) {
    if (name.value.length < 2) createButton.classList.add("disabled");else createButton.classList.remove("disabled");
  });
  createButton.addEventListener("click", function (ev) {
    createButton.classList.add("disabled");
    discardButton.classList.add("disabled");
    ...
    (0, _axios.default)({
      ...
      if (e.response.status === 405) {
        (0, _user_settings.showError)(405, "You exceeded the repository limit which means you cannot create a repository anymore." + " Delete some of your repositories or leave from the repositories that you \"can edit\". Error Code: ", 20);
      }
    });
  });
};

exports.createRepos = createRepos;

var leaveRepos = function leaveRepos(modal) {
  var leaveBtn = undefined;
  modal.addEventListener('show.bs.modal', function (event) {
    leaveBtn = event.relatedTarget;
  });
  var buttons = modal.getElementsByClassName("btn");
  buttons[0].addEventListener("click", function (ev) {
    if (leaveBtn) {
      var id = leaveBtn.getAttribute('data-bs-id');

      _axios.default.delete("".concat(window.location.href, "/").concat(id)).then(function (e) {
        var card = leaveBtn.parentElement.parentElement.parentElement;
        showSuccess("".concat(dictionary.d_left[_index.language], ": ").concat(card.children[0].children[1].getElementsByClassName("card-title")[0].innerText));
        card.remove();
      }).catch(function (e) {
        (0, _user_settings.showError)(e.response.status);
...
exports.leaveRepos = leaveRepos;

var deleteRepos = function deleteRepos(modal) {
  ...
  buttons[0].addEventListener("click", function (ev) {
    if (deleteBtn) {
      var id = deleteBtn.getAttribute('data-bs-id');

      _axios.default.delete("".concat(window.location.href, "/").concat(id, "/edit/auth")).then(function (e) {
        var card = deleteBtn.parentElement.parentElement.parentElement;
        showSuccess("".concat(dictionary.d_delete[_index.language], ": ").concat(card.children[0].children[1].getElementsByClassName("card-title")[0].innerText));
        card.remove();
      }).catch(function (e) {
        (0, _user_settings.showError)(e.response.status);
...
exports.deleteRepos = deleteRepos;
...
},{"axios":"../../node_modules/axios/index.js","validator/lib/isHexadecimal":"../../node_modules/validator/lib/isHexadecimal.js","./user_settings":"user_settings.js","./index":"index.js"}],"signup.js":[function(require,module,exports) {
"use strict";
...
var signup = function signup(form) {
  var fbTag = "custom-feedback";
  var email = document.getElementById("inEmail");
  var pass = document.getElementById("inPass");
  var passConfirm = document.getElementById("inPassConfirm");
  var name = document.getElementById("inName");
  var submitButton = document.getElementById("submitBtn");
  var successModal = document.getElementById("sModal");
  successModal.querySelectorAll(".btn").forEach(function (el) {
    el.addEventListener("click", function (ev) {
      return window.location.assign("/login");
    });
  });
  [email, pass, passConfirm, name].forEach(function (el) {
    el.addEventListener("input", function (ev) {
      el.classList.remove("is-invalid");
      el.classList.remove("valid");
    });
  });
  var modal = bootstrap.Modal.getOrCreateInstance(successModal);
  var emailFeedbacks = email.parentElement.getElementsByClassName(fbTag);
  var passFeedbacks = pass.parentElement.getElementsByClassName(fbTag);
  var nameFeedbacks = name.parentElement.getElementsByClassName(fbTag);
  submitButton.addEventListener("click", function (ev) {
    if (validateEmail() && (0, _user_settings.validateName)(name, nameFeedbacks) && validatePassword()) {
      if (passConfirm.value === pass.value) {
...
},{"axios":"../../node_modules/axios/index.js","./user_settings":"user_settings.js","validator/es/lib/isEmail":"../../node_modules/validator/es/lib/isEmail.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var loginForm = document.getElementById('loginCard');
var signupForm = document.getElementById("signupCard");
